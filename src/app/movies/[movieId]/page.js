...
export default function MovieId({ params }) {
    ...
    const [movie, setMovie] = useState({}); // Cambiar el estado inicial a un objeto vacío
    ...
    useEffect(() => {
        const fetchMovie = async () => {
            ...
            setMovie(data); // Asegurarse de que se está estableciendo el objeto de película correctamente
        }
        fetchMovie();
    }, [movieId]);
